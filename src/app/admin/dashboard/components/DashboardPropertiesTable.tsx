  ...
  return (
    <div className={`card ${className}`}>
      {properties ? (
                                ...
                                .map((user, i) => (
                                  <div className="position-relative" key={i}>
                                    <a
                                      ...
                                      target="_blank"
                                      key={user.id}
                                      className="symbol symbol-circle symbol-40px with-tooltip overflow-hidden"
                                      style={{
                                        marginRight: -20,
        ...
        <div className="d-flex align-items-center justify-content-center text-gray-600 w-100 fw-semibold fs-7 py-20">
