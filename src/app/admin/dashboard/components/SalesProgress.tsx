...
const SalesProgress: FC<Props> = ({ className, chartColor, chartHeight }) => {
  ...
  return (
    <div className={`card ${className}`}>
      ...
      <div className={`card-header border-0 bg-${chartColor} py-5`}>
        <h3 className="card-title fw-bold text-white">Kazançlar</h3>
        ...
        <div className="card-rounded bg-body mt-n10 position-relative card-px py-15">
          ...
          <div className="row g-0 mb-7">
            ...
            <div className="col mx-5">
              <div className="fs-6 text-gray-500">Özet</div>
              <div className="fs-2 fw-bold text-gray-800">Haziran Ayı</div>
            </div>
            {/* end::Col  */}
            ...
            <div className="col mx-5">
              ...
              <div className="fs-2 fw-bold text-gray-800">₺65.250</div>
            </div>
            {/* end::Col  */}
          </div>
          {/* end::Row  */}
          ...
          <div className="row g-0">
            ...
            {/* begin::Col  */}
            <div className="col mx-5">
              <div className="fs-6 text-gray-500">Toplam Ofis Gideri</div>
              <div className="fs-2 fw-bold text-gray-800">₺34.543</div>
            </div>
            {/* end::Col  */}
          </div>
          {/* end::Row  */}
