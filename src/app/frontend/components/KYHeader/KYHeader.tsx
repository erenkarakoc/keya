...
const KYHeader = () => {
  ...
  return (
    <>
      ...
      <div className={`ky-aside-nav${asideActive ? " active" : ""}`}>
        <div className="ky-aside-nav-title">
          ...
          <span
            className="ky-aside-nav-close"
            onClick={() => setAsideActive(false)}
          >
        ...
        <nav>
          <ul>
            ...
            <li>
              <a href="/ilanlar">İlanlarımız</a>
            </li>
            <li>
              <a href="/ofislerimiz">Ofislerimiz</a>
            </li>
            <li>
              <a href="/danismanlarimiz">Danışmanlarımız</a>
            </li>
          </ul>
        </nav>
        ...
        <div className="ky-aside-footer-wrapper row row-gap-10">
