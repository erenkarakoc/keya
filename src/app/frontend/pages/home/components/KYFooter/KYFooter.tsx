      ...
      <div className="ky-footer-wrapper">
        <div className="ky-footer-left">
          ...
          <KYText variant="paragraph" fontSize={16}>
            Uzun yıllardır gayrimenkul sektöründe etkin pazarlama ve danışmanlık
            hizmetleri vermekte olan Keya; giderek büyümekte olan hedefleri ile
            birlikte müşterilerine en iyi hizmeti vermek adına çalışmalarını
            sürdürmektedir.
          </KYText>
        </div>
        ...
        <nav className="ky-footer-right">
          ...
          <ul className="ky-footer-list">
            ...
            <li className="ky-footer-item">
              <Link to="/konut">Sabit Telefon</Link>
              <svg
                width="10"
                height="10"
                viewBox="0 0 10 10"
            ...
            <li className="ky-footer-item">
              <Link to="/proje">Cep Telefonu</Link>
              <svg
                width="10"
                height="10"
                viewBox="0 0 10 10"
            ...
            <li className="ky-footer-item">
              <Link to="/ticari">info@keya.com.tr</Link>
            </li>
            <li className="ky-footer-item">
              <Link to="/arsa">Turan Güneş Blv. No: 75, Çankaya, Ankara</Link>
            </li>
          </ul>
        </nav>
      </div>
