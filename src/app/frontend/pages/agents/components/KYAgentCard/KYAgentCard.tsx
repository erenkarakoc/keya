...
const KYAgentCard: React.FC<KYAgentCardProps> = ({ user }) => {
  ...
  return (
    <div className="ky-agent-card">
      ...
      <div className="ky-agent-card-image">
        <img
      ...
      <div className="ky-agent-card-footer">
        <div className="ky-agent-card-info">
          <div className="ky-agent-card-name">
        ...
        <div className="ky-agent-card-actions">
          ...
          <a
            ...
            className="ky-agent-card-action ky-agent-card-action-square"
          >
            <svg
              width="25"
              height="20"
