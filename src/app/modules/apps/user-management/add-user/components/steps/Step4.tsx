              ...
              <div className="fs-6 text-gray-600">
                ...
                <a
                  href={`https://api.whatsapp.com/send?phone=${values.phoneNumber.replace(
                    /\D/g,
                    ""
                  )}&text=${import.meta.env.VITE_APP_NAME}%20ailesine%20ho%C5%9F%20geldiniz!%20${import.meta.env.VITE_APP_NAME}%20ser%C3%BCveninizi%20y%C3%B6netece%C4%9Finiz%20aray%C3%BCz%C3%BCn%C3%BCze%20%22keya.com.tr%2Fgiris%22%20adresinden%2C%20a%C5%9Fa%C4%9F%C4%B1daki%20bilgileri%20kullanarak%20giri%C5%9F%20yapabilirsiniz%3A%0A%0AE-posta%3A%20${
                    values.email
