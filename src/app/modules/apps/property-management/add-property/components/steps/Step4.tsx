    ...
    <div className="w-100">
      <div className="pb-10 pb-lg-15">
        ...
        <div className="text-gray-500 fw-bold fs-6">
          İlan ekibine kullanıcılar ekleyin.
        </div>
      </div>
      ...
      <div className="mb-0">
        <div className="mb-10 fv-row">
          ...
          <div className="form-text">
            Lütfen ilan ekibine dahil etmek istediğiniz kullanıcıları seçin.
            Eğer ilaninizde çalışacak kullanıcılar henüz sisteme kayıtlı değilse
            daha sonra{" "}
            <Link
