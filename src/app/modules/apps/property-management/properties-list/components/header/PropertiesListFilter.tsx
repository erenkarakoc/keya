  ...
  return (
    <>
      ...
      >
        ...
        {/* begin::Content */}
        <div className="px-7 py-5" data-kt-property-table-filter="form">
          {/* begin::Input group */}
          <div className="mb-10">
            ...
            <select
              ...
              data-kt-property-table-filter="role"
            ...
            >
              ...
              <option value="assistant">İlan Asistanı</option>
          ...
          <div className="mb-10">
            ...
            <select
              ...
              data-placeholder="Select option"
              data-allow-clear="true"
              data-kt-property-table-filter="two-step"
              data-hide-search="true"
          ...
          <div className="d-flex justify-content-end">
            <button
              ...
              data-kt-property-table-filter="reset"
            >
              Sıfırla
            </button>
            <button
              ...
              data-kt-menu-dismiss="true"
              data-kt-property-table-filter="filter"
            >
              Uygula
            </button>
          </div>
